...
{
	$to = 'kiribiri_55@hotmail.com';
	$subject = 'Envío de Section 03 Form';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Nombre:</b></td><td>' . htmlentities($_REQUEST["custom_U2376"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Correo electronico:</b></td><td>' . htmlentities($_REQUEST["Email"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Comentario:</b></td><td>' . htmlentities($_REQUEST["custom_U2365"],ENT_COMPAT,'UTF-8') . '</td></tr>';
